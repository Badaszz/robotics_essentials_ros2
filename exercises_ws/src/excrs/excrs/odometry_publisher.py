...
class OdometryPublisher(Node):
    ...
    def joint_states_callback(self, joint_states):
        ...
        self.left_wheel_vel = joint_states.velocity[2]  # Left wheel velocity
        self.right_wheel_vel = joint_states.velocity[3]  # Right wheel velocity
        ...
        left_wheel_linear_vel = self.left_wheel_vel * self.wheel_radius
        right_wheel_linear_vel = self.right_wheel_vel * self.wheel_radius
        self.linear_velocity = (right_wheel_linear_vel + left_wheel_linear_vel) / 2.0
        self.angular_velocity = (right_wheel_linear_vel - left_wheel_linear_vel) / self.wheel_separation
        ...
        self.x += self.linear_velocity * math.cos(self.theta) * self.dt 
        self.y += self.linear_velocity * math.sin(self.theta) * self.dt
        ...
        odom_msg.twist.twist.linear.z = self.angular_velocity
